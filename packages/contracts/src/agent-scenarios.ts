    ...
    steps: [
      {
        ...
        runtimeMessage:
          "Researcher handoff update:\n"
          + "goal: launch StateCore for local-model developers\n"
          + "constraint: keep the launch self-hosted first\n"
          + "constraint: do not promise team collaboration yet",
        agentOutput:
      ...
      },
      {
        ...
        runtimeMessage:
          "Researcher handoff update:\n"
          + "risk: people may think StateCore is just another chat wrapper instead of a memory runtime\n"
          + "decision: landing page must defend the memory-runtime positioning",
      ...
      },
      {
        ...
        runtimeMessage:
          "Planner handoff question: given the current goal, constraints, and risks, what is the best next move for launch week?",
        agentOutput:
      ...
      },
      {
        ...
        runtimeMessage:
          "Executor handoff question: using the current goal, constraints, risks, and decisions, what exactly should the public landing page say right now?",
        agentOutput:
    ...
    steps: [
      {
        ...
        runtimeMessage:
          ...
          + "constraint: keep the public site online during mitigation\n"
          + "risk: users are actively evaluating the product while replay is down",
      ...
      },
      {
        ...
        runtimeMessage:
          "Researcher handoff update:\n"
          + "constraint: scope the incident to compare replay only\n"
          + "decision: do not treat overview or runtime as down",
      ...
      },
      {
        ...
        runtimeMessage:
          "Planner handoff question: given the current incident goal, constraints, and scope, what is the immediate mitigation plan?",
        agentOutput:
      ...
      },
      {
        ...
        runtimeMessage:
          "Executor handoff question: write the operator summary for the next on-call handoff using the current incident goal, constraints, scope, and mitigation decision.",
        agentOutput:

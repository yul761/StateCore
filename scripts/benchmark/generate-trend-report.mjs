...
const md = [
  ...
  `- Answer grounding: evidence ${latest.answerEvidenceCoverageRate}, ranking-reason ${latest.answerEventRankingReasonRate}, score ${latest.answerEventScoreRate}, state-summary ${latest.answerStateSummaryRate}, state-transition-taxonomy ${latest.answerStateTransitionTaxonomyRate}`,
  ...
  ...benchmarks.map((item) =>
    [
      ...
      `- Answer grounding: evidence ${item.answerEvidenceCoverageRate}, ranking-reason ${item.answerEventRankingReasonRate}, score ${item.answerEventScoreRate}, state-summary ${item.answerStateSummaryRate}, state-transition-taxonomy ${item.answerStateTransitionTaxonomyRate}`,

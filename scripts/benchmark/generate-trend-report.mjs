...
const md = [
  ...
  `- Retrieve mode: ${latest.retrieveMode}, hit ${latest.retrieveHitRate}, strict ${latest.retrieveStrictHitRate}, embedding requested ${latest.retrieveEmbeddingRequested ? "yes" : "no"}, configured ${latest.retrieveEmbeddingConfigured ? "yes" : "no"}, candidate limit ${latest.retrieveEmbeddingCandidateLimit ?? "default"}`,
  ...
  ...benchmarks.map((item) =>
    [
      ...
      `- Retrieve mode: ${item.retrieveMode}, hit ${item.retrieveHitRate}, strict ${item.retrieveStrictHitRate}, embedding requested ${item.retrieveEmbeddingRequested ? "yes" : "no"}, configured ${item.retrieveEmbeddingConfigured ? "yes" : "no"}, candidate limit ${item.retrieveEmbeddingCandidateLimit ?? "default"}`,

...
const lines = [
  ...
  ...summaries.map(
    (s) => [
      ...
      `- Answer grounding: ${s.answerSuccess}/${s.answerRuns} success, evidence ${s.answerEvidenceCoverageRate}, ranking-reason ${s.answerEvidenceEventRankingReasonRate}, score ${s.answerEvidenceEventScoreRate}, state-summary ${s.answerEvidenceStateSummaryRate}, state-transition-taxonomy ${s.answerEvidenceStateTransitionTaxonomyRate}`,
